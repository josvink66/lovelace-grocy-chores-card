...
class GrocyChoresCard extends s$1 {
    ...
    render() {
        ...
        return x`
            ...
            ${this.show_enable_reschedule ? this._renderRescheduleDialog() : T}
        `;
    }
        ...
        return x`
            <div class="${this.show_divider ? "grocy-item-container" : "grocy-item-container-no-border"} ${this.local_cached_hidden_items.includes(`${item.__type}${item.id}`) ? "hidden-class" : "show-class"} info flex" id="${item.__type}${item.id}">
                ...
                <div class="action-buttons">
                    ${this.show_enable_reschedule && (item.__type === "chore" || item.__type === "task") ? this._renderRescheduleButton(item) : T}
                    ${this.show_skip_next && (item.__type === "chore" || item.__type === "task") ? this._renderSkipButton(item) : T}
